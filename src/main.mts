...
const SUBGRAPH_URLS: Record<string, { decentralized: string }> = {
  ...
  "56": {
    decentralized:
      "https://gateway.thegraph.com/api/[api-key]/subgraphs/id/7h65Zf3pXXPmf8g8yZjjj2bqYiypVxems5d8riLK1DyR",
  },
};
...
function transformMarketsToTags(chainId: string, markets: Market[]): ContractTag[] {
  ...
  return validMarkets.map((market) => {
    ...
    return {
      ...
      "Public Note": `Venus v4's official ${market.name} token (Core)`,
    };
  });
}
